...
int main ()
{
  ...
  //test default constructor if its empty
  if (dll.is_empty()) {
    std::cout << "The list is empty." << endl << endl;
  } else {
    std::cout << "The list is not empty." << endl << endl;
  }
  ...
  DLList origDll;
  cout << "Test Move Constuctor" << endl;
  for (int i=10; i <= 100; i+=10) {
    origDll.insert_last(i);
  }
  cout << origDll << endl << endl;
